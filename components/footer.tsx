...
const navLinks = [
  ...
  { name: "Готовые решения", href: "#gallery" },
  {
    ...
    href: whatsappWithText("Здравствуйте! Хочу узнать про реферальную программу."),
    external: true,
  },
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="inline-block bg-foreground text-background px-4 py-2 text-xs hover:opacity-90 transition-opacity"
              >
